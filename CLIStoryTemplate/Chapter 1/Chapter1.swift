...
{
    if residentsAngry {
        return  "Residents flooded the precinct phone lines with reports of what they believed was a \"drunk driver\" in a \"half burned\" car driving wrecklessly. "
    } else {
...
func chapterOne() {
    ...
    print(sentence1, sentence2, sentence3, sentence4, sentence4, sentence5, sentence7, sentence6)
